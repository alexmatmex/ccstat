...
def get_nodes_info():
    pbsnodes = subprocess.check_output(["/mnt/rhel-6/huawei/torque/6.0.0/bin/pbsnodes -s pbs-smp -a"], shell=True)
...
def running_jobs_info():
    pbsnodes = subprocess.check_output(["/mnt/rhel-6/huawei/torque/6.0.0/bin/qstat @pbs-smp -f"], shell=True)
